...
func (c *permissionsClient) AddPermissionUser(ctx context.Context, in *PermissionUser, opts ...client.CallOption) (*PermissionUser, error) {
	req := c.c.NewRequest(c.serviceName, "Permissions.AddPermissionUser", in)
...
func (c *permissionsClient) RemovePermissionUser(ctx context.Context, in *PermissionUser, opts ...client.CallOption) (*PermissionUser, error) {
	req := c.c.NewRequest(c.serviceName, "Permissions.RemovePermissionUser", in)
	out := new(PermissionUser)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *permissionsClient) ListUserPermissions(ctx context.Context, in *PermissionUser, opts ...client.CallOption) (*PermissionsResponse, error) {
...
func (h *Permissions) AddPermissionUser(ctx context.Context, in *PermissionUser, out *PermissionUser) error {
...
func (h *Permissions) RemovePermissionUser(ctx context.Context, in *PermissionUser, out *PermissionUser) error {
...
func (h *Permissions) ListUserPermissions(ctx context.Context, in *PermissionUser, out *PermissionsResponse) error {
